<template>
  <div class="bg-white min-h-screen rounded-xl transition-all duration-300 ease-in-out">
    ...
    <div class="py-4 px-3">
      <div class="flex justify-between items-center mb-5 max-md:flex-wrap">
        ...
        <div class="flex items-center gap-3 max-md:flex-wrap">
          <svg class="max-md:w-7 max-md:h-7" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div @click="handleCreateWork" class="text-sm font-medium text-white py-[10px] cursor-pointer px-[14px] max-md:px-2 rounded-md bg-linear-gradient-2">Thêm công việc</div>
        </div>
      </div>
      ...
      <div>
        <div class="pl-7 pr-3 py-2 border border-color-7 rounded-xl relative box-work before:bg-color-9 mb-5 max-md:pl-4">
          <div class="flex justify-between items-center gap-2 mb-4 max-md:flex-wrap">
            <div class="flex gap-2 items-center w-1/3 max-md:w-full">
              ...
              <RouterLink :to="{ name : 'chitietcongviec'}" class="text-lg text-color-8 font-semibold line-clamp-1 flex-1 max-md:line-clamp-none">Thiết kế Website chuyên</RouterLink>
            </div>
            <div class="flex w-2/3 justify-between items-center max-md:w-full">
              <div class="text-sm font-medium text-color-3">Hoàng Anh - Mk1</div>
        ...
        <div class="pl-7 pr-3 py-2 border border-color-7 rounded-xl relative box-work before:bg-color-12 mb-5 max-md:pl-4">
          <div class="flex justify-between items-center gap-2 mb-4 max-md:flex-wrap">
            <div class="flex gap-2 items-center w-1/3 max-md:w-full">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_901_18031)">
