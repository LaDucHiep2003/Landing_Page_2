<template>
    <div class="w-[700px] h-[650px] bg-white p-4 rounded-2xl transition-all duration-300 ease-in-out overflow-y-auto"
      ...
      <div class=" flex justify-between items-center gap-2">
        ...
        <svg @click="handleCreateWork" class="cursor-pointer" width="24" height="24" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="border-b border-color-2 py-4">
        ...
        <div class="flex mb-4">
          ...
          <div class="relative flex-1 px-2">
            ...
            <label
                for="dropdownToggle"
                class="py-1 px-2 rounded-md flex items-center gap-1 bg-color-5 cursor-pointer w-fit"
            >
      ...
      <div class="border-b border-color-2 py-4">
        ...
        <div class="flex">
          ...
          <div class="flex-1">
            <input type="text" placeholder="Nhập mô tả..." class="text-base font-medium focus:bg-color-10 py-[6px] px-2 rounded-lg border focus:border-color-2 border-white text-color-3 focus:outline-none w-full">
          </div>
        </div>
      </div>
