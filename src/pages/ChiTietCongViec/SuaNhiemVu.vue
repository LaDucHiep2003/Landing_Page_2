  ...
  <div class="w-[700px] h-[650px] max-md:w-full max-md:h-full bg-white p-4 rounded-2xl transition-all duration-300 ease-in-out overflow-y-auto"
    ...
    <div class=" flex justify-between items-center gap-2">
      <input type="text" placeholder="Tên công việc" class="focus:outline-none border border-color-2 w-full py-2 px-4
          rounded-lg text-xl font-medium text-color-1" value="Xây dựng nội dung trang web">
      <svg @click="handleEditMission" class="cursor-pointer" width="24" height="24" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="grid grid-cols-2 items-center gap-3 mt-6">
      <div @click="handleEditMission" class="py-[10px] px-4 bg-color-10 rounded-md text-base font-semibold cursor-pointer text-color-3 text-center">Hủy</div>
