<template>
  <div class="py-4 flex justify-between items-center max-xl:flex-wrap">
    <div class="flex justify-between items-center gap-4 max-xl:flex-wrap">
    ...
    <div @click="handleMission" class="py-[10px] px-[14px] cursor-pointer rounded-md flex gap-2 items-center bg-linear-gradient-2">
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="text-base font-semibold text-white">Thêm nhiệm vụ</div>
    </div>
  </div>
</template>
<script>
