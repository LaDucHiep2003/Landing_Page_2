  ...
  <div class="w-[700px] h-[650px] max-md:w-full max-md:h-full bg-white p-4 rounded-2xl transition-all duration-300 ease-in-out overflow-y-auto"
    ...
    <div class=" flex justify-between items-center gap-2">
      <input type="text" placeholder="Tên công việc" class="focus:outline-none border border-color-2 w-full py-2 px-4
          rounded-lg text-xl font-medium text-color-1" value="Thiết kế Website bán hàng">
      <svg @click="handleEditWork" class="cursor-pointer" width="24" height="24" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="grid grid-cols-2 items-center gap-3 mt-10">
      ...
      <div class="py-[10px] px-4 bg-color-4 rounded-md text-base font-semibold cursor-pointer text-white text-center">Lưu</div>
    </div>
  </div>
</template>
<script>
export default {
  data() {
    return {
      ...
      fileName: "Báo cáo kinh doanh 2024.pdf",
    };
  },
  methods: {
    toggleDropdown() {
