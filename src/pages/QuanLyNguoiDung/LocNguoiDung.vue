  ...
  <div class="mb-4 flex justify-between items-center flex-wrap">
    <div class="flex justify-between items-center gap-4 flex-wrap">
      <label class="flex gap-1 border border-color-2 py-[10px] px-[14px] items-center rounded-lg bg-white w-[270px] max-md:w-full">
        ...
        <input type="text" class="focus:outline-none text-md text-color-3 pl-1" placeholder="Tìm kiếm nhân viên...">
      </label>
      ...
      <div class="flex bg-white rounded-lg w-[180px] border border-color-2 max-md:w-full max-md:mb-2">
        <div class="relative flex-1">
          ...
          <label
              ...
              class="flex gap-2 items-center justify-between w-full cursor-pointer py-[10px] px-[14px]"
          >
            <div class="text-base font-normal text-color-3">{{ selectedPosition }}</div>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M4 6L7.29289 9.29289C7.62623 9.62623 7.79289 9.79289 8 9.79289C8.20711 9.79289 8.37377 9.62623 8.70711 9.29289L12 6" stroke="#667085" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </label>
          ...
          >
            ...
            >
              ...
              <svg
                  v-if="selectedPosition === option.label"
                  width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"
              >
                <path d="M13.3334 4L6.00002 11.3333L2.66669 8" stroke="#667085" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
    ...
    <RouterLink :to="{ name : 'taonguoidung'}" class="py-[10px] px-[14px] cursor-pointer rounded-md flex gap-2 items-center bg-linear-gradient-2">
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="text-base font-semibold text-white">Tạo người dùng</div>
    </RouterLink>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    ...
    selectPosition(option){
      this.selectedPosition = option.label;
